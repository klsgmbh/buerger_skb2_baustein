   ...
   <out:template match="/*">
      <out:copy>
         ...
         <out:for-each select="anrede">
            <out:copy>
               <out:attribute name="ifp:label">Anrede:</out:attribute>
               <out:choose>
         ...
         <out:for-each select="f00000069">
            <out:copy>
               <out:attribute name="ifp:label">F00000069:</out:attribute>
               <out:choose>
                  <out:when test="@a:type='number'">
                     <out:attribute name="ifp:type">decimal</out:attribute>
                     <out:attribute name="xsi:type">xs:decimal</out:attribute>
         ...
         <out:for-each select="f00000071">
            <out:copy>
               <out:attribute name="ifp:label">F00000071:</out:attribute>
               <out:choose>
                  <out:when test="@a:type='number'">
                     <out:attribute name="ifp:type">decimal</out:attribute>
                     <out:attribute name="xsi:type">xs:decimal</out:attribute>
         ...
         <out:for-each select="iseid">
            <out:copy>
               <out:attribute name="ifp:label">iseid:</out:attribute>
               <out:attribute name="ifp:type">string</out:attribute>
               <out:value-of select="."/>
            </out:copy>
         </out:for-each>
